...
#### Solution
```{r, error = TRUE, fig.cap="Variances appear to differ a bit more than we would like, but we will still carryout the test"}
...
boxplot(Driver.deaths~type, data = carsafety, las = 2)
par(cex.lab=.1)
